            ...
            <b-col lg="6" class="my-1">
                <b-form-group
                    ...
                    <b-form-checkbox-group v-model="filterOn" class="mt-1">
                        <b-form-checkbox value="content">محتوا</b-form-checkbox>
    ...
    export default {
        ...
        data() {
            return {
                ...
                CSV: '',
                fields: [
                    {key: 'content', label: 'محتوا', sortable: true, sortDirection: 'asc'},
        ...
        methods: {
            ...
            getItems() {
                axios.get('/api/links/'+this.link_id+'/crawl/images')
                    .then(response => {
                        console.log(response.data.data);
            ...
            info(item, index, button) {
                this.infoModal.content = `شماره ردیف: ${index}`;
