<div class="col-sm-6 col-lg-3">
    <div class="card text-white bg-primary">
        ...
        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart1" height="87" width="322"
                    style="display: block; height: 70px; width: 258px;"></canvas>
            <div id="card-chart1-tooltip" class="chartjs-tooltip top bottom"
                 style="opacity: 0; left: 269.538px; top: 139.722px;">
...
<div class="col-sm-6 col-lg-3">
    <div class="card text-white bg-info">
        ...
        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart2" height="87" width="322"
                    style="display: block; height: 70px; width: 258px;"></canvas>
            <div id="card-chart2-tooltip" class="chartjs-tooltip top"
                 style="opacity: 0; left: 145.538px; top: 117.163px;">
                <div class="tooltip-header">
                ...
                <div class="tooltip-body">
                    <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                ...
                                class="tooltip-body-item-label">My First dataset</span><span
                                class="tooltip-body-item-value">17</span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card text-white bg-warning">
        <div class="card-body pb-0">
            <div class="btn-group float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{!! route('tickets.index') !!}">@lang('List of Messages')</a>
                </div>
            </div>
            <div class="text-value">{{count(\Illuminate\Support\Facades\Auth::user()->messages)}}</div>
            <div>@lang('New Messages')</div>
        </div>
        <div class="chart-wrapper mt-3" style="height:70px;">
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart3" height="87" width="362"
                    style="display: block; height: 70px; width: 290px;"></canvas>
        </div>
    </div>
</div>
...
<div class="col-sm-6 col-lg-3">
    <div class="card text-white bg-danger">
        ...
        <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
            ...
            <canvas class="chart chartjs-render-monitor" id="card-chart4" height="87" width="322"
                    style="display: block; height: 70px; width: 258px;"></canvas>
        </div>
    </div>
</div>
