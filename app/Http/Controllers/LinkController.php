...
class LinkController extends AppBaseController
{
    ...
    {
        $links = $this->linkRepository->paginate(10);
    ...
    public function store(CreateLinkRequest $request)
    {
        ...
        Flash::success(__('Link').' '.__('saved successfully.'));
    ...
    public function show($id)
    {
        ...
        if (empty($link)) {
            Flash::error(__('Link').' '.__('not found.'));
    ...
    public function update($id, UpdateLinkRequest $request)
    {
        ...
        Flash::success(__('Link').' '.__('updated successfully.'));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('Link').' '.__('deleted successfully.'));
