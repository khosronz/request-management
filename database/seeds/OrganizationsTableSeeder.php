...
class OrganizationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        \Illuminate\Support\Facades\DB::table('organizations')->insert([
            ...
            ['title' => 'فناوری اطلاعات','desc' => 'سوالات مربوط به فروش', 'parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'زیرساخت', 'desc' => 'پشتیبانی فنی','parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'امنیت', 'desc' => 'مشکلات و خطاهای مربوط به لایسنس','parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'پشتیبانی','desc' => 'حساب کاربری و گزارش های خرید', 'parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'ایمنی', 'desc' => 'گزارش خاطا و باگ','parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'درخواست قابلیت', 'desc' => 'درخواست قابلیت های مورد نیاز','parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'پشتبانی', 'desc' => 'سرویس و پشتیبانی','parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'هاست','desc' => 'دریافت نمایندگی', 'parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
            ['title' => 'وی پی اس','desc' => 'دریافت نمایندگی', 'parent_id'=>1,'created_at' => now(), 'updated_at' => now()],
        ]);
